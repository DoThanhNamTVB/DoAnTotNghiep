...
import { getAllOrder, getOrderById } from '~/store/actions';
...
function HistoryOrderDetail() {
    ...
    return (
        <div className=" py-3 px-5">
            <div className="py-3">
                <Link to={routesConfig.historyOrder} className=" fs-3">
                    <BsSkipBackwardFill />
            ...
            <div className="order-product my-5">
                <table className="table table-striped">
                    <thead>
                        <tr>
                            <th colSpan="9" className="text-center pb-3">
                                DANH SÁCH SẢN PHẨM
                            </th>
                        </tr>
                        <tr>
                            ...
                            order?.Products.map((item, index) => {
                                return (
                                    <tr key={index}>
                                        ...
                                        <th scope="row">{`${item?.Category?.slug}-${item?.id}`}</th>
                                        <td>
