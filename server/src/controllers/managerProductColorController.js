...
const createProductColor = async (req, res) => {
    ...
    try {
        ...
        const reponse =
            await managerProductColorService.createProductColorService(info);
...
const getAllByIdProductColorColor = async (req, res) => {
    try {
        ...
        const response =
            await managerProductColorService.getAllByIdProductColorService(
                idProduct
            );
...
const getAnByIdProductColor = async (req, res) => {
    try {
        ...
        const response =
            await managerProductColorService.getAnByIdProductColorService(
                idProduct,
                idColor
            );
        return res.status(200).json(response);
...
const updateProductColor = async (req, res) => {
    try {
        ...
        const response =
            await managerProductColorService.updateProductColorService(
                info,
                idProduct,
                idColor
            );
...
const deleteProductColor = async (req, res) => {
    try {
        const { idProduct, idColor } = req.params;
        const response =
            await managerProductColorService.deleteProductColorService(
                idProduct,
                idColor
            );
        return res.status(200).json(response);
