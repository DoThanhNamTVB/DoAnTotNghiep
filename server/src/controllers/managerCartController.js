...
const createCartController = async (req, res) => {
    try {
        ...
        const response = await managerCartService.createCartService(
            req.body,
            userId
        );
...
const getCartByUserIdController = async (req, res) => {
    try {
        const userId = req.params.userId;
        const response = await managerCartService.getCartByUserIdService(
            userId
        );
        res.status(200).json(response);
    } catch (error) {
...
const updateCartController = async (req, res) => {
    try {
        ...
        const response = await managerCartService.updateCartService(
            req.body,
            userId,
            productId
        );
...
const deleteCartController = async (req, res) => {
    try {
        const { userId, productId } = req.params;
        const response = await managerCartService.deleteCartService(
            userId,
            productId
        );
        res.status(200).json(response);
